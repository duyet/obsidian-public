---
title: "Isometric Extraction with Gemini"
description: Extract objects from photos and render them as clean isometric 3D models.
---
...
Upload an image containing the object you want to extract.

## Customization

Modify `[Building Only]` to extract different subjects:
- `[Vehicle Only]` - Extract cars, trucks, etc.
...
- [Original post by @Zieeett](https://x.com/Zieeett/status/1960420874806247762)
